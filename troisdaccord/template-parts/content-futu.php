...
<div id="conteneur-light-box">
    <div id="light-box">
        <h1>
            <div class="texte-titre">Mon titre gp</div>
        </h1>
        <p class="contenu-lightbox">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras a pellentesque ex. In sit amet consectetur nulla. Proin vulputate dictum elit. Nulla fringilla quam sit amet neque tempus rhoncus sed eu dolor. Ut et quam a nulla tempor dignissim. Fusce tempus metus libero, sit amet varius tortor vestibulum at.</p>
        <p class="contenu-lightbox">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras a pellentesque ex. In sit amet consectetur nulla. Proin vulputate dictum elit. Nulla fringilla quam sit amet neque tempus rhoncus sed eu dolor. Ut et quam a nulla tempor dignissim. Fusce tempus metus libero, sit amet varius tortor vestibulum at.</p>
        <div class="barres">
